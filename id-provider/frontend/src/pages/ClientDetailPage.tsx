...
export default function ClientDetailPage() {
  ...
  const handleRevokeSecret = async () => {
    if (!id || !confirm('Are you sure you want to revoke and regenerate the client secret? The old secret will no longer work.')) {
      return;
    }
